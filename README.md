...
* **Features:** Customizable context menu, Quick sharing options, Multi-file support (up to 4 files).
* **Download:** [Latest Release](https://github.com/ServalC4t/Right-Click-to-Share/releases/latest)
